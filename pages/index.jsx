...
export default function App() {
  ...
  const getBalance = async () => {
    if (crowdFundingSigner) {
      const balance = await crowdFundingSigner.getAmountRaised();
      setBalance(balance);
    }
  };
      ...
      return (
        <div className="w-full h-full flex justify-center items-center">
          <a
            ...
            target="_blank"
            className="text-white cursor-pointer bg-blue-900 text-3xl py-5 px-10 mt-10 underline rounded-full border-[3px] border-gray-300 hover:border-white"
          >
      ...
      return (
        <div className="flex flex-col justify-center items-center w-full h-full">
          <button
            ...
            className="bg-slate-200 border-2 border-black px-10 py-5 rounded-full text-3xl font-bold flex gap-5 items-center"
          >
            {/* metamask logo svg */}
            <svg
